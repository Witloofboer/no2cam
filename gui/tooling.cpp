...
QLineEdit *new_NumberEdit(const QString &inputMask)
{
    ...
    result->setFixedWidth(result->fontMetrics().width(inputMask+"00"));
...
QLineEdit *new_EetEdit()        { return new_NumberEdit("09.9");  }
QLineEdit *new_CooldownEdit()   { return new_NumberEdit("09.9");  }
